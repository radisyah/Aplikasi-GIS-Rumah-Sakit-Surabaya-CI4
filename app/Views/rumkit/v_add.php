...
<div class="col-sm-5">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <?php endif; ?>
      <?php echo form_open_multipart('rumahSakit/save_add'); ?>
      <div class="form-group">
        <label>Nama Rumah Sakit</label>
        <input name = "nama_rumkit" class="form-control" placeholder="Nama Rumah Sakit" >
      </div>
      <div class="form-group">
        <label>Alamat</label>
      ...
      <div class="form-group">
        <label>No Telp</label>
        <input name = "no_telpon" class="form-control" placeholder="No Telp">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input name = "latitude" id="lat" class="form-control" placeholder="Latitude">
      </div>
      <div class="form-group">
        <label>Longitude</label>
        <input name = "longtitude" id="long" class="form-control" placeholder="Longitude">
      </div>
      <div class="form-group">
        <label>Foto</label>
